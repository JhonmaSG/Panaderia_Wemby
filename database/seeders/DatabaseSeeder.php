...
use App\Models\Proveeedor;
use App\Models\Proveeedores_producto;
use App\Models\Rol;
use App\Models\User;
...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $proveedorProducto1 = new Proveeedores_producto();
        $proveedorProducto1->id_proveedor = 1;
        $proveedorProducto1->id_producto = 1;
        $proveedorProducto1->save();

        $proveedorProducto2 = new Proveeedores_producto();
